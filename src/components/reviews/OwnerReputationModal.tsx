...
interface OwnerReputationModalProps {
  open: boolean;
...
export const OwnerReputationModal = ({
  open,
  onOpenChange,
  ownerId,
  ownerName,
  ownerImage,
}: OwnerReputationModalProps) => {
  const { data: stats, isLoading } = useOwnerReviews(ownerId);
              ...
              {!stats || stats.reviews.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-muted-foreground">
                    Este proprietário ainda não tem avaliações.
                  </p>
                </div>
              ) : (
